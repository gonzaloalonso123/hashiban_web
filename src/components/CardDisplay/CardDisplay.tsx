      ...
      <div className="transition-all duration-100">
        {/* {!opened ? (
          <div className="flex flex-col pb-24 pt-16 items-center justify-center">
            ...
            <p className=" text-xs mb-10">({t("click_to_see")})</p>
            <motion.img
              src={box}
              ref={boxRef}
              className="cursor-pointer transform transition-all duration-300 max-w-64 xl:pl-10 brightness-95 hover:drop-shadow-xl hover:brightness-100"
              onClick={openBox}
