		...
		<div className="w-full bg-black">
			<div className="max-w-4xl p-4 mx-auto">
				...
				<Section title={t('guide_special_objects_title')} icon={<GiCardJoker className="text-2xl" />}>
					<CardWithTitleAndText title={t('guide_special_objects_action_title')}>
						<Paragraph>
							{t('guide_special_objects_action_text')}
						</Paragraph>
						<DetailsSection>
							<ParagraphWithArrow>
					...
					<CardWithTitleAndText title={t('guide_special_objects_weapon_title')}>
						<Paragraph>
...
const BigTitle = ({ children }) => {
	return <h1 className="text-xl font-bold underline mb-5">{children}</h1>;
};
...
const Section = ({ title, icon, children }) => <section className="my-10"><SectionTitle icon={icon} >{title}</SectionTitle>{children}</section>
...
const CardWithTitleAndText = ({ title, children }) => (
...
const SectionTitle = ({ icon, children }) =>
	<h1 className="text-2xl font-bold my-4 p-1 border flex items-center gap-3 border-blue-400 rounded-md w-fit px-3 bg-blue-500">{icon} {children}</h1>

const DetailsSection = ({ children }) => <div className="border border-yellow-200 p-2 pt-8 rounded-md relative my-8">
	{children}
</div>
